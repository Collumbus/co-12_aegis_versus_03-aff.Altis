...
[
	{true}, 
		...
		["Situation",
			"October 21st 2024: PMC Versus local high command (callsign 'Corona') has finally established a satellite link to Versus reconnaissance satellite Hannibal-6 at FOB Aurum. Corona has located the third and final <marker name='obj1'>base</marker> of the Nekron Chelia fighters and has tasked two five operator teams to eliminate the extremists. The <marker name='perditus_start'>point team</marker> (callsign 'Perditus') has been inserted north of the base and the <marker name='derelictus_start'>supporting team</marker> (callsign 'Derelictus') south of the base. Corona reminds the teams to not let any of the NC fighters escape as that would jeopardize Versus presence on Altis.<br/><br/>Corona has been monitoring AAF radio communication channels and learned that an AAF combat engineer team's <marker name='obj3'>temporary observation point</marker> east of the NC base contains plenty of explosives fit for future Versus operations on Altis. The combat engineers are observing the 14 wind turbines on the nearby hills and performing maintenance as needed. Corona has learned that disabling the <marker name='obj2'>key turbine</marker> west of the observation point will render the others unresponsive. This should be enough to cause the combat engineers leave the vicinity of their base and investigate even though it's night.<br/><br/>Versus operators must deliver the AAF <marker name='obj3'>Kamaz truck</marker> containing the explosives <marker name='obj4'>north-east</marker> of the observation point and leave the AO. Corona will provide intel by monitoring the situation via the satellite uplink and AAF radio channels. The Versus operators are equipped with the weapons stolen from the NC earlier this week, enjoy."],

		["Enemy",
			"Corona estimates that the Nekron Chelia fighters at the base are rather poorly armed and disorganized due to the fact that the extremists have no leader and have already lost some 70 percent of their fighters. Versus operators and the NC lack NV capabilities but the sky is clear and visibility good for a night time operation.<br/><br/>The AAF fighters at the observation point however are heavily armed, trained and organized and Derelictus and Perditus are to approach with extreme caution. Corona has also spotted movement near the small airstrip in the south-east. Thermals suggest several vehicles, most likely AAF. The reason for their presence remains unknown.<br/><br/>Perditus and Derelictus are equipped with all the explosives Versus has on Altis and Corona advises the operators to use them wisely and make the acquisition of the Zamak truck priority. Corona has already identified several potential targets all around Altis to help PMC Versus destabilize the Altian government and cause turmoil among the citizens."],
